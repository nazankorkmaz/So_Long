...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/17 10:21:57 by nkorkmaz          #+#    #+#             */
/*   Updated: 2023/08/18 13:55:41 by nkorkmaz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	file_to_image(t_win *win)
{
	...
	win->chr->chr_down = mlx_xpm_file_to_image(win->mlx,
			"./textures/cekic3.xpm", &win->chr->size, &win->chr->size);
	win->chr->chr_up = mlx_xpm_file_to_image(win->mlx,
			"./textures/cekic4.xpm", &win->chr->size, &win->chr->size);
	win->chr->chr_l = mlx_xpm_file_to_image(win->mlx,
			"./textures/cekic2.xpm", &win->chr->size, &win->chr->size);
	win->chr->chr_r = mlx_xpm_file_to_image(win->mlx,
			"./textures/cekic1.xpm",
			&win->chr->size, &win->chr->size);
	win->exit = mlx_xpm_file_to_image(win->mlx,
			"./textures/thor.xpm", &win->chr->size, &win->chr->size);
	win->wall = mlx_xpm_file_to_image(win->mlx,
			"./textures/kalkan2.xpm", &win->chr->size, &win->chr->size);
	win->coin = mlx_xpm_file_to_image(win->mlx,
			"./textures/loki.xpm", &win->chr->size, &win->chr->size);
	win->enemy = mlx_xpm_file_to_image(win->mlx,
			"./textures/x.xpm", &win->chr->size, &win->chr->size);
}
